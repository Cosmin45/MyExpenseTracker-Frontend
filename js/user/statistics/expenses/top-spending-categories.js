function updateTopSpendingCategoriesChart(informations)
{
    const data = informations.topSpendingCategories;
    const labels = [];
    const values = [];
    ...
    const expensesDistributionCtx = document.querySelector("#statistics-expenses-top-spending-categories-container canvas").getContext("2d");
