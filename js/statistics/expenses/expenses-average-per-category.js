function updateExpensesAveragePerCategoryChart(informations)
{
    const data = informations.expensesAveragePerCategory;
    const labels = [];
    const values = [];
    ...
    const expensesDistributionCtx = document.querySelector("#statistics-expenses-average-by-category-container canvas").getContext("2d");
    ...
    const expensesChart = new Chart(expensesDistributionCtx, 
        ...
        options: {
            ...
            plugins: {
                title: {
                display: true,
                text: "Expenses Average Per Category",
                font: {
                    size: 20,
                    weight: "bold"
                },
